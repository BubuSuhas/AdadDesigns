...
<div ng-controller="myController" ng-init="getProductList()"  class="col-md-8 w3ls_dresses_grid_right">
					...
					<div class="clearfix"> </div>
						...
						<div class="w3ls_dresses_grid_right_grid2_left">
							<h3>Search: <input type="text" ng-model="searchCondition"
							placeholder="Search Product"> </h3>
					...
					<div class="w3ls_dresses_grid_right_grid3">						
						<div ng-repeat="p in products | filter:searchCondition" class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses">
